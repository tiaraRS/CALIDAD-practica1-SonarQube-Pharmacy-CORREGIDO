...
urlpatterns = [
    ...
    path('admin_user/all_patients/', HODViews.all_patients_form, name='all_patients'),
    ...
    path('admin_user/add_category/', HODViews.add_category_form, name='add_category'),
    path('admin_user/add_category/post/', HODViews.add_category, name='add_category_post'),
    ...
    path('admin_user/hod_profile/edit_admin_profile/',
         HODViews.edit_admin_form, name='edit-admin'),
    path('admin_user/hod_profile/edit_admin_profile/post/',
         HODViews.edit_admin, name='edit-admin_post'),
    ...
    path('admin_user/edit_doctor/<doctor_id>/',
         HODViews.edit_doctor_form, name="edit_doctor"),
    path('admin_user/edit_doctor/<doctor_id>/post/',
         HODViews.edit_doctor, name="edit_doctor_post"),
    path('admin_user/edit_receptionist/<clerk_id>/',
         HODViews.edit_pharmacy_clerk_form, name="edit_clerk"),
    path('admin_user/edit_receptionist/<clerk_id>/post/',
         HODViews.edit_pharmacy_clerk, name="edit_clerk_post"),
    path('admin_user/edit_drug/<pk>/', HODViews.edit_stock_form, name="edit_drug"),
    path('admin_user/edit_drug/<pk>/post/', HODViews.edit_stock, name="edit_drug_post"),
