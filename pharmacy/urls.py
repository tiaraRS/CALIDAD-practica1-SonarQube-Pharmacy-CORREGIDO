...
urlpatterns = [
    ...
    path('admin_user/add_pharmacy_clerk/',
         HODViews.create_pharmacy_clerk, name='add_pharmacyClerk'),
    ...
    path('admin_user/delete_doctor/<str:pk>/',
         HODViews.delete_doctor, name='delete_doctor'),
    path('admin_user/delete_pharmacist/<str:pk>/',
         HODViews.delete_pharmacist, name='delete_pharmacist'),
    path('admin_user/delete_receptionist/<str:pk>/',
         HODViews.delete_pharmacy_clerk, name='delete_clerk'),
